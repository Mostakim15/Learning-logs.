...
"""If APP_DIRS = True is set in settings.py, Django automatically looks for templates inside each apps templates folder.

For example:
ap_nm/templates/ap_nm/home.html
Then in the view:
return render(request, "ap_nm/home.html")
Django will find the file correctly.

If you use a project-level templates folder, such as:
project/templates/base.html
You must add this in settings.py:
'DIRS': [BASE_DIR / 'templates'],
Otherwise, Django will not be able to find base.html."""
